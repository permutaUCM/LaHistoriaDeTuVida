...
namespace LHDTV.Controllers
{
    ...
    public class AdministrationController : ControllerBase
    {
        ...
        public IActionResult removeTag(string id)
        {
            ...
            try
            {
                var tag = tagMasterService.Delete(id, 0);
                return Ok(tag);
            }
            catch (Exception e)
            {
        ...
        public IActionResult getAllTags()
        {
            ...
            try
            {
                ...
                var tag = tagMasterService.ReadAll(null, 0);
                return Ok(new
                {
                    Data = tag,
                    Metadata = new
                    {
                        Extras = this.tagMasterService.GetAllExtras()
                    }
                });
            }
            catch (Exception e)
